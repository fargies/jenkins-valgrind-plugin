 ...
 * @author Ulli Hafner
 */
public class LeaksTablePortlet extends AbstractWarningsTablePortlet {
    /**
     * Creates a new instance of {@link LeaksTablePortlet}.
     *
     * @param name
     *            the name of the portlet
     */
    @DataBoundConstructor
    public LeaksTablePortlet(final String name) {
        super(name);
    }
    ...
    public static class WarningsPerJobDescriptor extends Descriptor<DashboardPortlet> {
        ...
        public String getDisplayName() {
            return Messages.Portlet_LeaksTable();
        }
    }
}
