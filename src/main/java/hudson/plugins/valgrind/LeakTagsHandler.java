 ...
 * @author Ulli Hafner
 */
public class LeakTagsHandler implements Serializable {
    ...
    /**
     * Creates a new instance of <code>LeakTagsHandler</code>.
     *
     * @param high
     *            tag identifiers indicating high priority
     * @param normal
     ...
     *             References all the warnings.
     */
    public LeakTagsHandler(final String high, final String normal, final String low, final AnnotationContainer provider) {
        this.high = high;
        this.normal = normal;
        this.low = low;
