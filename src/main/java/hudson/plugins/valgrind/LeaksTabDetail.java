 ...
 * @author Ulli Hafner
 */
public class LeaksTabDetail extends TabDetail {
     ...
     */
    public LeaksTabDetail(final AbstractBuild<?, ?> owner, final Collection<FileAnnotation> annotations, final String url, final String defaultEncoding) {
